...
def _parse_cover_metadata(workbook, default_year: int) -> tuple[date, date, int]:
...
def _find_vi_table_start(sheet) -> int:
    starts: list[int] = []
    preferred: list[int] = []
