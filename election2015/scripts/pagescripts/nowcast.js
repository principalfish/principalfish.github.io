...
function selectAreaInfo(value){
	...
	if (value == "northeastengland") {parseData("/election2015/data/nowcastregions/northeastengland.csv", doStuff)};
	if (value == "northwestengland") {parseData("/election2015/data/nowcastregions/northwestengland.csv", doStuff)};
	if (value == "southwestengland") {parseData("/election2015/data/nowcastregions/southwestengland.csv", doStuff)};
	if (value == "southeastengland") {parseData("/election2015/data/nowcastregions/southeastengland.csv", doStuff)};
	if (value == "london") {parseData("/election2015/data/nowcastregions/london.csv", doStuff)};
	if (value == "wales") {parseData("/election2015/data/nowcastregions/wales.csv", doStuff)};
	if (value == "northernireland") {parseData("/election2015/data/nowcastregions/northernireland.csv", doStuff)};
	if (value == "yorkshireandthehumber") {parseData("/election2015/data/nowcastregions/yorkshireandthehumber.csv", doStuff)};
	if (value == "eastmidlands") {parseData("/election2015/data/nowcastregions/eastmidlands.csv", doStuff)};
	if (value == "westmidlands") {parseData("/election2015/data/nowcastregions/westmidlands.csv", doStuff)};
	if (value == "greatbritain") {parseData("/election2015/data/nowcastregions/greatbritain.csv", doStuff)};
}
