...
function getMapInfo(){
	parseData("/election2015/data/retrospective_info.csv", getSeatInfo);
...
function getInfoFromFiles(){
	...
	parseData("/election2015/data/retrospectiveregions/projectionvotetotals.csv", getVoteTotalsInitial);

	// get rest of vote totals for later

	parseData("/election2015/data/retrospectiveregions/greatbritain.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/england.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/scotland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/wales.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/northernireland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/northeastengland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/northwestengland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/southeastengland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/southwestengland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/london.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/eastmidlands.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/westmidlands.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/eastofengland.csv", getVoteTotals);
	parseData("/election2015/data/retrospectiveregions/yorkshireandthehumber.csv", getVoteTotals);
...
function resetInputs(){
  ...
  parseData("/election2015/data/retrospective_info.csv", getSeatInfoAgain);
