...
// ─── Predict ─────────────────────────────────────────────────────────────────
//
// Renders the predict input window (regional uniform-swing grid) and wires its action
// buttons. The window is mutually exclusive with the seat card on the right rail when
// visible — that layout coupling is the only shared concern between predict and the
// rest of dom.js.
...
seatCardObserver.observe(predictWindow);
